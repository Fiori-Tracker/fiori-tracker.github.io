...
| ZNYPE_FT | Fiori Tracker Core Manager - The role to manage the list with [Specification](../specification-records.md) application details (optional) |
| ZNYPE_ASISCEN | "As-is" Main API Manager - The role to manage data synchronization for "As-is" application details (optional) |
| ZNYPE_AI | Apps Import Manager - The role to manage importing of application details into [Specification](../specification-records.md) application details in Fiori Tracker Core (optional) |
